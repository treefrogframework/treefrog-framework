...
class T_CORE_EXPORT TActionController : public QObject, public TAbstractController, public TActionHelper, protected TAccessAuthenticator
{
    Q_OBJECT
public:
    TActionController();
...
protected:
    ...
    bool authenticateAccess(const TAbstractUser *user);
