...
const QMap<int, QByteArray> reasonPhrase = {
    ...
    {(int)Tf::StatusCode::MisdirectedRequest, "Misdirected Request"},
    {(int)Tf::StatusCode::UnprocessableContent, "Unprocessable Content"},
    {(int)Tf::StatusCode::Locked, "Locked"},
    {(int)Tf::StatusCode::FailedDependency, "Failed Dependency"},
    {(int)Tf::StatusCode::TooEarly, "Too Early"},
    {(int)Tf::StatusCode::UpgradeRequired, "Upgrade Required"},
    {(int)Tf::StatusCode::PreconditionRequired, "Precondition Required"},
    {(int)Tf::StatusCode::TooManyRequests, "Too Many Requests"},
    {(int)Tf::StatusCode::RequestHeaderFieldsTooLarge, "Request Header Fields Too Large"},
    {(int)Tf::StatusCode::UnavailableForLegalReasons, "Unavailable For Legal Reasons"},
    // Server Error 5xx
