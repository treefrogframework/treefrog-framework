...
<span style="color: #b22222">**概要:在你增加了一个新模版文件后, 使用"make qmake"命令.** </span>
## 输出字符串
...
<span style="color: #b22222">**概要:仅使用一次fetch.** </span>
...
<span style="color: #b22222">**概要:布局(layout)就是网站设计的页面轮廓.** </span>
...
<span style="color: #b22222">**概要:定义固定显示的区域为布局(layout), 不固定显示的区域为内容块(partial) .** </span>